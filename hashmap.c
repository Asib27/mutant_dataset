...
int main(char* argv, int argc)
{
    ...
    for (index=0; index<KEY_COUNT; index+=1)
    {
        ...
        value = (struct data_struct_s *)malloc(sizeof(data_struct_t));
...
//mutation
unsigned long crc32_2(const unsigned char *s, unsigned int len)
{
  unsigned int i;
  unsigned long crc32val;
...
//mutation
unsigned int hashmap_hash_int_2(hashmap_map * m, char* keystring){

    unsigned long key = crc32_2((unsigned char*)(keystring), strlen(keystring));
